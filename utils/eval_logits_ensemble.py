...
logits_csv_files_list = [
    'checkpoints/inceptionv4_11-fold-1/eval_logits.csv',
    'checkpoints/se_resnext101_32x4d_11-fold-1/eval_logits.csv'
]
...
logits_ensemble_csv_filename = 'ensemble_results/eval_logits_ensemble.csv'
...
pred_ensemble_csv_filename = 'ensemble_results/eval_pred_ensemble.csv'
